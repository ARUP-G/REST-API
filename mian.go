...
func main() {
	...
	//data
	books = append(books, Book{ID: "1", ISBN: "86348", Title: "Book1", Author: &Author{FName: "ar", LName: "erds"}})
	books = append(books, Book{ID: "2", ISBN: "85578", Title: "Book2", Author: &Author{FName: "rer", LName: "das"}})
